...
const WorkoutLog = () => {
  ...
  const chartData = {
    ...
    datasets: [{
      ...
      data: workouts.map(workout => Number(workout.caloriesBurned)), 
  ...
  return (
    <div className="container mt-5 p-4" style={{ backgroundColor: "grey", border: "4px solid black", borderRadius: "15px" }}>
      <h2 className='p-3' style={{ borderRadius: "8px", backgroundColor: "black", color: "white" }}>Log Your Workout</h2>
      ...
      <h2 className="mt-5 p-3" style={{ borderRadius: "8px", backgroundColor: "black", color: "white" }}>Set Weekly Goals</h2>
      ...
      <h2 className="mt-5 p-3" style={{ borderRadius: "8px", backgroundColor: "black", color: "white" }}>Workouts</h2>
      <div className="row">
      ...
      <h2 className="mt-5 p-2" style={{ borderRadius: "8px", backgroundColor: "black", color: "white" }}>Weekly Goals</h2>
      <div className="row">
      ...
      <h2 className="mt-5 p-3" style={{ borderRadius: "8px", backgroundColor: "black", color: "white" }}>Workout Trend</h2>
